#!/bin/bash --login
#SBATCH -J test3-RCSR-ums_opt
#SBATCH -o test3-RCSR-ums_opt-%J.o
...
export JOB=test3-RCSR-ums_opt
export DIR=$SLURM_SUBMIT_DIR
export scratch=$SCRATCH/workflow_20250622_094530/step_001_OPT/test3-RCSR-ums_opt
