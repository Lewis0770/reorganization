#!/bin/bash --login
#SBATCH -J 3,4^2T9-CA_opt_doss
#SBATCH -o 3,4^2T9-CA_opt_doss-%J.o
...
#SBATCH -t 02:00:00
#SBATCH --mem=48G
export JOB=3,4^2T9-CA_opt_doss
export DIR=$SLURM_SUBMIT_DIR
export scratch=$SCRATCH/workflow_20250622_094524/step_004_DOSS
