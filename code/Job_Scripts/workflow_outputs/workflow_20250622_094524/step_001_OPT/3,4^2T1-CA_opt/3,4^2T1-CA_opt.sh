#!/bin/bash --login
#SBATCH -J 3,4^2T1-CA_opt
#SBATCH -o 3,4^2T1-CA_opt-%J.o
...
export JOB=3,4^2T1-CA_opt
export DIR=$SLURM_SUBMIT_DIR
export scratch=$SCRATCH/workflow_20250622_094524/step_001_OPT/3,4^2T1-CA_opt
