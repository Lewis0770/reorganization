...
echo '# Workflow context for queue manager' >> $1.sh
echo 'export MACE_WORKFLOW_ID="workflow_20250725_123705"' >> $1.sh
echo 'export MACE_CONTEXT_DIR="${SLURM_SUBMIT_DIR}/.mace_context_workflow_20250725_123705"' >> $1.sh
echo 'export MACE_ISOLATION_MODE="isolated"' >> $1.sh
